...
export default class LessonService {
  ...
  /**
   * Get the lesson information of one lesson out the DB from the given lesson-id
   * @param lessonInputDTO
   * @constructor
   */
  ...
  /**
   * Get all lessons from the DB by the given Course-id
   * @param courseInputDTO
   * @constructor
   */

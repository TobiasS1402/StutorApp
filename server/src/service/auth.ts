...
export default class AuthService {
  ...
  /**
   * Make a new user with generated keys in the database, sends token and userdata back to application
   * @param userInputDTO
   * @constructor
   */
  public async SignUp(
  ...
  /**
   * Search for a user in DB with the given parameter if found send user info back
   * @param userInputDTO
   * @constructor
   */
  public async SignIn(
  ...
  /**
   * Check in database of given pin is correct to the user his pin in the database
   * Generate a token and send that token with userdata back to application
   * @param userInputDTO
   * @constructor
   */
